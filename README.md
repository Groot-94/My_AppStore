...
- [x] SwiftUI 앱 타깃 + 검색·앱 상세 마이그레이션 (ViewModel 무수정 재사용)
- [ ] 나머지 4탭 SwiftUI 마이그레이션 (투데이 / 게임 / 앱 / 아케이드) — 완료 시 SwiftUI 전용 DesignSystem 모듈 분리
- [ ] 다듬기 — 스켈레톤/애니메이션/접근성, 게임 탭 로드 최적화
- [ ] 링크 방식 검토 — 동적 프레임워크 19개의 런치 타임 비용 측정 후 static / mergeable libraries 판단
